...
registerPlugins({
  ...
  "syntax-export-default": require("@babel/plugin-syntax-export-default"),
  "syntax-export-namespace": require("@babel/plugin-syntax-export-namespace"),
  ...
  "proposal-export-namespace": require("@babel/plugin-proposal-export-namespace"),
